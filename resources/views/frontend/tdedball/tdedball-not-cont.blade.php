...
@section('fb_url')
    <meta property="og:url"				content="https://dooball-th.com/ทีเด็ดบอลรอง">
@endsection
@section('fb_title')
...
@endsection
@section('global_url')
    <link href="https://dooball-th.com/ทีเด็ดบอลรอง" rel="canonical">
@endsection
                    ...
                    <table class="table table-condensed text-white">
                        <thead class="card-prediction">
                            <tr>
                                ...
                                <th class="text-center">ทีเด็ดบอลรองที่เลือก</th>

...
@section('fb_url')
    <meta property="og:url"				content="https://dooball-th.com/ทีเด็ดบอลสเต็ป3">
@endsection
@section('fb_title')
...
@endsection
@section('global_url')
    <link href="https://dooball-th.com/ทีเด็ดบอลสเต็ป3" rel="canonical">
@endsection
                        ...
                        @if($prev != '' || $next != '')
                            <tfoot>
                                <tr>
                                    ...
                                    <th colspan="2" class="text-right">{!! $next !!}</th>
                                </tr>
                            </tfoot>
                        @endif
                    </table>

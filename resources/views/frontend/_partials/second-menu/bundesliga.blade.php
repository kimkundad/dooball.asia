<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownSubMenu" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        บุนเดสลีกา <span class="sr-only">(current)</span>
    </a>
    ...
    <div class="dropdown-menu first-level" aria-labelledby="navbarDropdownSubMenu">
        <div class="dropdown-header d-flex alit-center">
            <img src="{{ asset('images/league/icon-bundesliga.png') }}" width="30">
            &nbsp;&nbsp;บุนเดสลีกา 2019 - 2020
        </div>
        <a class="dropdown-item" href="#">กราฟราคาบอลไหลบุนเดสลีกา</a>
        <a class="dropdown-item" href="{{ route('analysis') }}">วิเคราะห์บอลบุนเดสลีกา</a>
        <a class="dropdown-item" href="{!! url('/dooball') !!}">ดูบอลบุนเดสลีกา</a>
        <a class="dropdown-item" href="{!! url('/highlights') !!}">ไฮไลท์บุนเดสลีกา</a>
        <a class="dropdown-item this-is-show-sub" href="{!! url('/score') !!}">
            <div class="dropdown-submenu">
                <a href="{!! url('/score') !!}" class="text-link-sub d-flex alit-center just-between dropdown-toggle" data-toggle="dropdown">ผลบอลบุนเดสลีกา</a>

<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownSubMenu" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        พรีเมียร์ลีก <span class="sr-only">(current)</span>
    </a>
    ...
    <div class="dropdown-menu first-level" aria-labelledby="navbarDropdownSubMenu">
        <div class="dropdown-header d-flex alit-center">
            <img src="{{ asset('images/league/icon-premier.jpg') }}" width="30">
            &nbsp;&nbsp;พรีเมียร์ลีก 2019 - 2020
        </div>
        <a class="dropdown-item" href="#">กราฟราคาบอลไหลพรีเมียร์ลีก</a>
        <a class="dropdown-item" href="{{ route('analysis') }}">วิเคราะห์บอลพรีเมียร์ลีก</a>
        <a class="dropdown-item" href="{!! url('/dooball') !!}">ดูบอลพรีเมียร์ลีก</a>
        <a class="dropdown-item" href="{!! url('/highlights') !!}">ไฮไลท์พรีเมียร์ลีก</a>
        <a class="dropdown-item this-is-show-sub" href="{!! url('/score') !!}">
            <div class="dropdown-submenu">
                <a href="{!! url('/score') !!}" class="text-link-sub d-flex alit-center just-between dropdown-toggle" data-toggle="dropdown">ผลบอลพรีเมียร์ลีก</a>

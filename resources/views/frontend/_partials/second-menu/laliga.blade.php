<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownSubMenu" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ลาลีกา <span class="sr-only">(current)</span>
    </a>
    ...
    <div class="dropdown-menu first-level" aria-labelledby="navbarDropdownSubMenu">
        <div class="dropdown-header d-flex alit-center">
            <img src="{{ asset('images/league/icon-LaLiga.jpg') }}" width="30">
            &nbsp;&nbsp;ลาลีกา 2019 - 2020
        </div>
        <a class="dropdown-item" href="#">กราฟราคาบอลไหลลาลีกา</a>
        <a class="dropdown-item" href="{{ route('analysis') }}">วิเคราะห์บอลลาลีกา</a>
        <a class="dropdown-item" href="{!! url('/dooball') !!}">ดูบอลลาลีกา</a>
        <a class="dropdown-item" href="{!! url('/highlights') !!}">ไฮไลท์ลาลีกา</a>
        <a class="dropdown-item this-is-show-sub" href="{!! url('/score') !!}">
            <div class="dropdown-submenu">
                <a href="{!! url('/score') !!}" class="text-link-sub d-flex alit-center just-between dropdown-toggle" data-toggle="dropdown">ผลบอลลาลีกา</a>

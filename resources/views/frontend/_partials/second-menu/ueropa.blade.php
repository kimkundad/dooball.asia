<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownSubMenu" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ยูโรปา <span class="sr-only">(current)</span>
    </a>
    ...
    <div class="dropdown-menu first-level" aria-labelledby="navbarDropdownSubMenu">
        ...
        <a class="dropdown-item" href="#">กราฟราคาบอลไหลยูโรปา</a>
        <a class="dropdown-item" href="{{ route('analysis') }}">วิเคราะห์บอลยูโรปา</a>
        <a class="dropdown-item" href="{!! url('/dooball') !!}">ดูบอลยูโรปา</a>
        <a class="dropdown-item" href="{!! url('/highlights') !!}">ไฮไลท์ยูโรปา</a>
        <a class="dropdown-item this-is-show-sub" href="{!! url('/score') !!}">
            <div class="dropdown-submenu">
                <a href="{!! url('/score') !!}" class="text-link-sub d-flex alit-center just-between dropdown-toggle" data-toggle="dropdown">ผลบอลยูโรปา</a>

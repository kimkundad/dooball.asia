...
@section('fb_url')
    <meta property="og:url"				content="https://dooball-th.com/live">
@endsection
@section('fb_title')
...
@endsection
@section('global_url')
    <link href="https://dooball-th.com/live" rel="canonical">
@endsection
        ...
        <div class="row my-3 prediction-table-area">
            <div class="col-12">
                <div class="table-responsive">
                    <table class="table table-condensed text-white live-table">
                        <tr>
                            <td>
...
@section('custom-scripts')
    ...
    <script>
        ...
        function live() {
            $.ajax({
                url: $('#base_url').val() + '/api/live',
                type: 'GET',
                dataType: 'json',
                cache: false,
                success: function (response) {
                    arrangeLiveBackend(response.small_league, response.big_league, response.mode);
                },
        ...
        function arrangeLiveBackend(smallLeagues, bigLeagues, mode) {
            var bigHtml = genTableBackend(bigLeagues, mode);
            $('.live-table').html(bigHtml);
            ...
            setTimeout(function(){
                ...
                if (count >= 600) { // refresh page if over than 10 minutes
                    location.reload();
                } else {
                    live();
                }

...
@section('content')
    @section('breadcrumb')
        ...
        <li><a onclick="Javascript:void(0);"><span class="icon icon-double-angle-right"></span>แก้ไขเกมทายผล</a></li>
    @endsection
    <form role="form" id="prediction_form">
        @csrf
        <input type="hidden" name="prediction_id" id="prediction_id" value="{{ $form->id }}">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control" name="league_name" id="league_name" value="{{ $form->league_name }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control" name="match_time" id="match_time" value="{{ $form->match_time }}" placeholder="{{ Date('Y-m-d H:i:s') }}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control" name="home_team" id="home_team" value="{{ $form->home_team }}" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control" name="away_team" id="away_team" value="{{ $form->away_team }}" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control" name="bargain_price" id="bargain_price" value="{{ $form->bargain_price }}" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <input type="text" class="form-control" name="match_result" id="match_result" value="{{ $form->match_result }}" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <a class="btn btn-lg btn-default" href="{{ url('/') }}/admin/prediction"><i class="fa fa-close"></i>&nbsp;ยกเลิก</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        function submitForm(this_form) {
            Swal.fire({
                ...
                onOpen: () => {
                    ...
                    $.ajax({
                        url: $('#base_url').val() + '/api/admin/prediction/save-update',
                        type: 'POST',
                        data: formData,
                        dataType: 'json',
                        cache: false,

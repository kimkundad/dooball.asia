...
@section('title', 'จัดการป้ายกำกับ')

@section('content')
    @section('breadcrumb')
        <li><a onclick="Javascript:void(0);">ป้ายกำกับ</a></li>
    @endsection
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                รายการป้ายกำกับทั้งหมด&nbsp;<span class="text-primary text-bold" id="result_tag_total"><i class="fa fa-spinner"></i></span>&nbsp;รายการ
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="row mbt-10">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                <select class="form-control" name="chk_action" id="chk_action" onchange="doSomethingWithIt($(this), 'tag')">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="table-responsive">
                                    <table id="table_tag" class="table table-striped table-condensed table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th class="text-center pr-5 no-sort" id="th_chk_all"></th>
                                                <th class="text-left">ป้ายกำกับ</th>
    ...
    <script>
        ...
        function dataTable() {
            table = $('#table_tag').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": $('#base_url').val() +'/api/admin/tag/list',
                    "type":"POST",
                    ...
                    error: function(response) {
                        ...
                        checkReload(response.status, 'tag');
                    }
                },
                "ordering": true,
                "fnDrawCallback":  function (oSettings, json) {
                    ...
                    $('#result_tag_total').html(oSettings.fnRecordsTotal());
        ...
        function tickAll(this_ele) {
            $('.tr-tag').each(function (idx, ele) {
                $(this).html(tr_tag[idx]);
            });

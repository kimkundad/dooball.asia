...
@section('content')
    @section('breadcrumb')
        <li><a onclick="Javascript:void(0);">ทีม</a></li>
    @endsection
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                รายการทีมทั้งหมด&nbsp;<span class="text-primary text-bold" id="result_team_total"><i class="fa fa-spinner"></i></span>&nbsp;รายการ
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="row mbt-10">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                <select class="form-control" name="chk_action" id="chk_action" onchange="doSomethingWithIt($(this), 'team')">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 text-right">
                                <a href="{{ URL::to('/') }}/admin/team/create">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="table-responsive">
                                    <table id="table_team" class="table table-striped table-condensed table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                {{-- <th class="text-center pr-5 no-sort" id="th_chk_all"></th> --}}
                                                <th class="text-center no-sort">#</th>
                                                <th class="text-left">ลีก</th>
                                                <th class="text-left">API ID</th>
                                                <th class="text-left">ชื่อทีม (TH)</th>
                                                <th class="text-left">ชื่อทีม (EN)</th>
                                                <th class="text-left">Short name</th>
                                                <th class="text-left">Long name</th>
                                                <th class="text-left">Search dooball</th>
                                                <th class="text-left">Search graph</th>
                                                <th class="text-left">Onpage</th>
    ...
    <script>
        ...
        function dataTable() {
            table = $('#table_team').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": $('#base_url').val() +'/api/admin/team/list',
                    "type":"POST",
                    ...
                    error: function(response) {
                        ...
                        checkReload(response.status, 'team');
                    }
                },
                "ordering": true,
                "fnDrawCallback":  function (oSettings, json) {
                    ...
                    $('#result_team_total').html(oSettings.fnRecordsTotal());

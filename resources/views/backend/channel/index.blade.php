...
@section('title', 'จัดการช่องรายการทีวี')

@section('content')
    @section('breadcrumb')
        <li><a onclick="Javascript:void(0);">ช่องรายการทีวี</a></li>
    @endsection
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                รายการทั้งหมด&nbsp;<span class="text-primary text-bold" id="result_channel_total"><i class="fa fa-spinner"></i></span>&nbsp;รายการ
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="row mbt-10">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                <select class="form-control" name="chk_action" id="chk_action" onchange="doSomethingWithIt($(this), 'channel')">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12 text-right">
                                <a href="{{ URL::to('/') }}/admin/channel/create">
                                    <span class="btn btn-success add-btn"><i class="fa fa-plus"></i>&nbsp;เพิ่มช่องรายการทีวี</span>
                                </a>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-pdd">
                                <div class="table-responsive">
                                    <table id="table_channel" class="table table-striped table-condensed table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th class="text-center pr-5 no-sort" id="th_chk_all"></th>
                                                <th class="text-left">ชื่อช่อง</th>
    ...
    <script>
        ...
        function dataTable() {
            table = $('#table_channel').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": $('#base_url').val() +'/api/admin/channel/list',
                    "type":"POST",
                    ...
                    error: function(response) {
                        ...
                        checkReload(response.status, 'channel');
                    }
                },
                "ordering": true,
                "fnDrawCallback":  function (oSettings, json) {
                    ...
                    $('#result_channel_total').html(oSettings.fnRecordsTotal());

                                    ...
                                    <table id="table_page" class="table table-striped table-condensed table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-left no-sort">ชื่อเพจ</th>
                                                <th class="text-left no-sort">วันที่สร้าง</th>
                                                <th class="text-left no-sort">ผู้สร้าง</th>
                                                <th class="text-left">แสดงบนเมนู</th>
    ...
    <script>
        ...
        function dataTable() {
            table = $('#table_page').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": $('#base_url').val() +'/api/admin/page/list',
                    "type":"POST",
        ...
        function tickAll(this_ele) {
            $('.tr-page').each(function (idx, ele) {
                $(this).html(tr_page[idx]);
            });

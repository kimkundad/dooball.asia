    ...
    <div class="panel-body">
        ...
        <div class="box-image-name mt-10">
            <div class="input-group">
                <input type="text" class="form-control" name="img_name" id="img_name" value="{{ $form->img_name }}" placeholder="ชื่อภาพ" readonly />
                <span class="input-group-addon" id="img_ext">{{ $form->img_ext }}</span>
            </div>
        </div>

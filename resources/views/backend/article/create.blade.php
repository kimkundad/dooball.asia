...
@section('content')
    @section('breadcrumb')
        ...
        <li><a onclick="Javascript:void(0);"><span class="icon icon-double-angle-right"></span>เพิ่มบทความ</a></li>
    @endsection
            ...
            <div class="row">
                            ...
                            <div class="tab-content">
                                <div id="thai" class="tab-pane fade in active">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="description_th" id="description_th" value="" maxlength="200" />
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="row">
                                                ...
                                                <select class="select-team" name="team_id" id="team_id">
                                                    ...
                                                    @if(count($teams) > 0)
                                                        @foreach($teams as $team)
                                                            <option value="{{ $team->id }}">{{ $team->team_name_en . ' : ' . $team->team_name_th }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="tags" id="tags" value="" data-role="tagsinput" />
                                        <br />
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="rd-group">
                                <input type="radio" name="publishing_option" id="publish" value="1" checked />
                            ...
                            <div class="rd-group">
                                <input type="radio" name="publishing_option" id="no_publish" value="0" />
                                <label class="rd text-danger" for="no_publish">บันทึกแบบไม่เผยแพร่</label>
                                <div class="check"></div>
                            </div>
                            {{-- <div class="admin-cbox mt-10">
                                <input type="checkbox" class="chkb" id="featured_article" value="3" />
                                <label class="cb" for="featured_article">ตั้งค่าเป็นบทความเด่น</label>
                            </div> --}}
                        </div>
                        <div class="panel-footer">
                            <button type="button" class="btn btn-md btn-primary">บันทึก</button>
                        </div>
                    </div>
                    @include('backend._partials.article.add-cover')
                </div>
            </div>
        </section>
    </form>
        ...
        function submitForm(this_form) {
            Swal.fire({
                ...
                onOpen: () => {
                    ...
                    $.ajax({
                        url: $('#base_url').val() + '/api/admin/article/save-create',
                        type: 'POST',
                        data: formData,
                        dataType: 'json',
                        cache: false,

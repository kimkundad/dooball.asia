...
@section('content')
    @section('breadcrumb')
        <li><a onclick="Javascript:void(0);">บทความ</a></li>
    @endsection
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                รายการบทความทั้งหมด&nbsp;<span class="text-primary text-bold" id="result_article_total"><i class="fa fa-spinner"></i></span>&nbsp;รายการ
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="row mbt-10">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                <select class="form-control" name="chk_action" id="chk_action" onchange="doSomethingWithIt($(this), 'article')">
                                    ...
                                    <table id="table_article" class="table table-striped table-condensed table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-left no-sort">ภาพปกบทความ</th>
                                                <th class="text-left">หัวข้อบทความ</th>
                                                <th class="text-left no-sort">ผู้ลงบทความ</th>
    ...
    <script>
        ...
        function dataTable() {
            table = $('#table_article').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": $('#base_url').val() +'/api/admin/article/list',
                    "type":"POST",
        ...
        function tickAll(this_ele) {
            $('.tr-article').each(function (idx, ele) {
                $(this).html(tr_article[idx]);
            });

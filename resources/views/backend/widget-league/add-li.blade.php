...
@section('title', 'เพิ่มรายการย่อยใน' . $form->decoration_title)
                                ...
                                <form role="form" id="widget_league_form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" name="title" id="title" placeholder="ตัวอย่าง: ตารางสถิตินักเตะ" maxlength="125">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" name="slug" id="slug" placeholder="ตัวอย่าง: premierleague/topscore" maxlength="125">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="form-group">
        ...
        function submitForm(this_form) {
            Swal.fire({
                ...
                onOpen: () => {
                    ...
                    $.ajax({
                        url: $('#base_url').val() + '/api/admin/league-decoration/save-li-create',
                        type: 'POST',
                        data: formData,
                        dataType: 'json',
                        cache: false,

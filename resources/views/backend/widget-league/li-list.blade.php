...
@section('title', 'จัดการรายการย่อย')
...
@section('content')
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-9 col-sm-9 pddt7">
                                รายการย่อยของ{{ $form->decoration_title }}ทั้งหมด&nbsp;<span class="text-primary text-bold" id="result_wgl_total"><i class="fa fa-spinner"></i></span>&nbsp;รายการ
                            </div>
                            <div class="col-md-3 col-sm-3 text-right">
                                <a href="{{ URL::to('/') }}/admin/settings/league-decoration/{{ $form->decoration_id }}/add-item">
    ...
    <input type="hidden" id="decoration_id" value="{{ $form->decoration_id }}">
@endsection
    ...
    <script>
        ...
        function dataTable() {
            table = $('#table_wgl').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": $('#base_url').val() +'/api/admin/league-decoration/li-list',
                    "type":"POST",
                    "beforeSend": function(response){
                        response.setRequestHeader('X-CSRF-TOKEN', $('meta[name="csrf-token"]').attr('content'));
                    },
                    "data": function(d){
                        d.decoration_id = $('#decoration_id').val();

...
@section('content')
    @section('breadcrumb')
        ...
        <li><a onclick="Javascript:void(0);"><span class="icon icon-double-angle-right"></span>แก้ไขเมนู</a></li>
    @endsection
                                ...
                                <form role="form" id="menu_form">
                                            ...
                                            <select class="form-control" name="parent_id" id="parent_id">
                                                ...
                                                @if ($parents)
                                                    @foreach ($parents as $parent)
                                                        <option value="{{$parent->id}}" {{ ($form->parent_id == $parent->id)? 'selected' : '' }}>{{$parent->menu_name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" name="menu_name" id="menu_name" value="{{$form->menu_name}}" maxlength="70" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group no-parent">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" name="menu_url" id="menu_url" value="{{$form->menu_url}}" maxlength="125" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" name="menu_icon" id="menu_icon" value="{{$form->menu_icon}}" maxlength="25" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <input type="number" class="form-control" name="menu_seq" id="menu_seq" value="{{$form->menu_seq}}" min="0" max="20" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <select class="form-control" name="menu_status" id="menu_status">
                                                <option value="1" {{ ($form->menu_status == 1) ? 'selected' : '' }}>ใช้งาน</option>
                                                <option value="2" {{ ($form->menu_status == 2) ? 'selected' : '' }}>ไม่ใช้งาน</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
        ...
        function submitForm(this_form) {
            Swal.fire({
                ...
                onOpen: () => {
                    ...
                    $.ajax({
                        url: $('#base_url').val() + '/api/admin/menu/save-update',
                        type: 'POST',
                        data: formData,
                        dataType: 'json',
                        cache: false,
